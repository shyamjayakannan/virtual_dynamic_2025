...
static const char *CompileLibs[] = {
    ...
    "libcar.a	CarMaker-Car win64 12.0.3 2024-06-17",
    "libcarmaker.a	CarMaker win64 12.0.3 2024-06-17",
    "libipgdriver.a	IPGDriver win64 12.0.3 2024-06-13",
    "libipgroad.a	IPGRoad win64 12.0.3 2024-06-14",
...
static const char *CompileFlags[] = {
    "-m64 -O3 -DNDEBUG -DWIN32 -DWIN64 -DCM_NUMVER=120003",
...
tAppStartInfo   AppStartInfo = {
    "CarMaker 12.0.3 - Car_Generic",          /* App_Version         */
    "3",          /* App_BuildVersion    */
    "jetbrains",     /* App_CompileUser     */
    "8f8ceb12e178",         /* App_CompileSystem   */
    "2024-06-17 12:44:33",  /* App_CompileTime */
