...
** - when starting a new TestRun, if
...
** - when a TestRun is finished (SimCore.State is SCState_End)
*/
...
** Call:
** - in separate thread (no realtime conditions)
** - when a TestRun is finished (SimCore.State is SCState_End<xyz>)
*/
